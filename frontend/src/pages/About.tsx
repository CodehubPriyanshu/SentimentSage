  ...
  const openTeamModal = () => {
    setModalContent({
      ...
      content: (
        <div className="space-y-6 text-left">
          <p className="text-gray-300">
            SentimentSage was developed as a final year project by BCA students
            at ITM University. Our team combines expertise in artificial
            intelligence, natural language processing, and web development.
          </p>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mt-8">
            <div className="card p-6">
              <h4 className="text-lg font-bold text-white">Priyanshu Kumar</h4>
              <p className="text-gray-400 mt-2">
                Responsible for implementing the core sentiment analysis
            ...
            <div className="card p-6">
              ...
              <p className="text-gray-400 mt-2">
                Specialized in training and fine-tuning the NLP models for
                sentiment analysis.
              </p>
            </div>
            <div className="card p-6">
              ...
              <p className="text-gray-400 mt-2">
                Designed and implemented the user interface and visualization
                components.
              </p>
            </div>
            <div className="card p-6">
              ...
              <p className="text-gray-400 mt-2">
                Focused on system integration, authentication, and deployment
                infrastructure.
              </p>
            </div>
            <div className="card p-6">
              ...
              <p className="text-gray-400 mt-2">
                Provided expert guidance and mentorship throughout the
                development process.
              </p>
            </div>
          </div>
      ...
      <div className="container mx-auto px-4 py-16">
        <div className="max-w-4xl mx-auto animate-fade-in">
          ...
          <p className="text-gray-300 text-lg text-center mb-12">
            A final year project by BCA students at ITM University, harnessing
            AI to analyze social media sentiment
          </p>
