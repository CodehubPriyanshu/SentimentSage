...
const PlatformCard: React.FC<PlatformCardProps> = ({
  ...
  return (
    <div className="card p-6 flex flex-col md:flex-row items-center md:items-start gap-4">
      ...
      <div>
        <h3 className="text-xl font-bold text-white dark:text-white light:text-navy mb-2 text-center md:text-left">
          {name}
        </h3>
        <p className="text-gray-400">{description}</p>
      </div>
      ...
      <div className="container mx-auto px-4 py-16">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-gray-300 text-lg text-center mb-12 animate-fade-in">
            Unlock the power of AI to understand audience sentiment and
                  ...
                  openFeatureModal(
                    ...
                    <div className="space-y-4">
                      <p className="text-gray-300">
                        Our advanced sentiment analysis engine uses a
                        combination of natural language processing and machine
                        learning to accurately classify comments based on their
                        emotional tone.
                      </p>
                      <div className="card p-4">
                        ...
                        <ul className="list-disc pl-5 mt-2 text-gray-300">
                          <li>
                            Identify the overall sentiment of your audience
                          </li>
                          <li>
                            Spot potentially negative feedback that requires
                            attention
                          </li>
                          <li>
                            Understand emotional responses to different types of
                            content
                          </li>
                      ...
                      <p className="text-gray-300">
                        The system can detect subtleties in language, including
                        sarcasm, idioms, and context-specific expressions,
                        providing you with accurate sentiment analysis across
              ...
              <FeatureCard
                ...
                onClick={() =>
                  openFeatureModal(
                    ...
                    <div className="space-y-4">
                      <p className="text-gray-300">
                        Transform complex sentiment data into clear, actionable
                        visualizations that make it easy to understand your
                        audience's feelings at a glance.
                      </p>
                      <div className="card p-4">
                        <h4 className="text-lg font-bold text-white">
                      ...
                      <p className="text-gray-300">
                        ...
                        to focus on specific time periods, sentiment categories,
              ...
              <FeatureCard
                ...
                onClick={() =>
                  openFeatureModal(
                    ...
                    <div className="space-y-4">
                      <p className="text-gray-300">
                        Build a comprehensive view of your audience's sentiment
                        over time by saving and organizing your analysis
                        results.
                      </p>
                      <div className="card p-4">
                        <h4 className="text-lg font-bold text-white">
                        ...
                        <ul className="list-disc pl-5 mt-2 text-gray-300">
                          ...
                          <li>
                            Organize analyses by campaign, platform, or custom
                            categories
                          </li>
                      ...
                      <p className="text-gray-300">
                        Our tracking features help you identify long-term
                        patterns in audience sentiment, allowing you to refine
                        your content strategy based on historical performance.
                      </p>
                    </div>
                  )
                }
              ...
              <FeatureCard
                ...
                onClick={() =>
                  openFeatureModal(
                    ...
                    <div className="space-y-4">
                      <p className="text-gray-300">
                        Never lose valuable insights with our comprehensive
                      ...
                      <p className="text-gray-300">
                        Our historical data features let you track the evolution
                        of audience sentiment across campaigns, seasons, or
                        product lifecycles, giving you deeper insight into what
              ...
              <FeatureCard
                ...
                onClick={() =>
                  openFeatureModal(
                    ...
                    <div className="space-y-4">
                      <p className="text-gray-300">
                        Go beyond basic sentiment analysis with our AI's
                        intelligent insights that highlight patterns, anomalies,
                        and opportunities in your audience data.
                      </p>
                      <div className="card p-4">
                        <h4 className="text-lg font-bold text-white">
                        ...
                        <ul className="list-disc pl-5 mt-2 text-gray-300">
                          ...
                          <li>
                            Correlation between content types and sentiment
                          </li>
                      ...
                      <p className="text-gray-300">
                        Our AI continually learns from your specific audience,
                        becoming more accurate and relevant with each analysis,
                        providing increasingly valuable insights over time.
                      </p>
                    </div>
                  )
                }
              ...
              <FeatureCard
                ...
                onClick={() =>
                  openFeatureModal(
                    ...
                    <div className="space-y-4">
                      <p className="text-gray-300">
                        Transform audience insights into actionable content
                        strategies with our AI-powered content recommendation
                        system.
                      </p>
                      <div className="card p-4">
                        <h4 className="text-lg font-bold text-white">
                        ...
                        <ul className="list-disc pl-5 mt-2 text-gray-300">
                          <li>
                            Content topic suggestions based on positive
                            sentiment patterns
                          </li>
                          <li>Optimal posting time recommendations</li>
                          <li>
                            Content format suggestions (video, image, text)
                          </li>
                      ...
                      <p className="text-gray-300">
                        Our recommendations are based on your specific
                        audience's preferences and behaviors, not generic
                        advice, ensuring that your content strategy is perfectly
                        tailored to your unique community.
                      </p>
                    </div>
                  )
                }
            ...
            <div className="card p-8 animate-fade-in">
              ...
              <div className="space-y-6">
                ...
                <div className="bg-navy-dark p-4 rounded-lg">
                  ...
                  <p className="text-gray-300">
                    Our advanced AI models don't just classify comments—they
                    identify patterns and trends, offering actionable
                    recommendations to improve engagement and audience sentiment
                    over time.
                  </p>
                </div>
              </div>
