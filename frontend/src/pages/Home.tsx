...
const CommentCard: React.FC<CommentCardProps> = ({
  ...
  return (
    <div
      className={`p-3 border-l-4 ${colors[sentiment]} bg-navy-light bg-opacity-60 rounded-r mb-3`}
    >
      ...
      content: (
        <div className="space-y-6 text-left">
          <p className="text-gray-300">
            SentimentSage uses advanced AI models to analyze social media
            comments and provide valuable insights into audience sentiment.
          ...
          <div className="space-y-4">
            <div className="card p-4">
              ...
              <p className="text-gray-300">
                We gather comments from your social media posts across multiple
                platforms, preserving context and metadata for the most accurate
                analysis.
              </p>
            </div>
            <div className="card p-4">
              ...
              <p className="text-gray-300">
                Our sophisticated machine learning models analyze the comments
                to determine sentiment, identify key topics, and extract
                actionable insights.
              </p>
            </div>
            <div className="card p-4">
              ...
              <p className="text-gray-300">
                We transform the raw data into clear, intuitive visualizations
                and comprehensive reports that help you understand your audience
                better.
              </p>
            </div>
          </div>
      ...
      <div className="container mx-auto px-4 pt-16 pb-24">
        <div className="flex flex-col lg:flex-row gap-12">
          ...
          <div className="flex-1 animate-fade-in">
            ...
            <p className="text-gray-400 dark:text-gray-400 light:text-gray-dark text-lg mt-6 max-w-2xl">
              Free to access comment analysis in text to uncover sentiment,
              engagement patterns, and gain valuable insights into your
              audience.
            </p>
            ...
            <div className="mt-16">
              <h2 className="text-2xl font-bold text-white dark:text-white light:text-navy mb-6">
                How SentimentSage Works
              </h2>
              ...
              <div className="text-center mt-8">
                <Button
                  ...
                  className="dark:text-white light:text-navy dark:border-white light:border-navy"
                >
            ...
            <div className="mt-16 grid md:grid-cols-3 gap-8">
              <div className="card p-6 hover:shadow-xl transition-shadow">
                ...
                <p className="text-gray-400 dark:text-gray-400 light:text-gray-dark">
                  Our AI provides precise sentiment analysis with over 95%
                  accuracy.
                </p>
              </div>
          ...
          <div className="lg:w-96 mt-12 lg:mt-0">
            <div className="card animate-fade-in">
              <h2 className="text-xl font-bold text-white dark:text-white light:text-navy mb-4">
                Sentiment Overview
              </h2>
              ...
              <h3 className="text-lg font-medium text-white dark:text-white light:text-navy mb-3">
                Sample Comments
              </h3>
              ...
              <div className="mt-4 text-center">
                {user && (
                  <Link to="/analysis">
                    <Button
                      variant="outline"
                      className="dark:text-white light:text-navy dark:border-white light:border-navy hover:bg-blue/10"
                    >
