  ...
  const steps = [
    {
      ...
      description: "Paste your comments or upload a CSV file containing comments from social media platforms."
    },
    {
      icon: <BarChart2 className="h-10 w-10 text-blue" />,
      title: "Analyze Sentiment",
      description: "Our AI will process the comments and categorize them as positive, neutral, or negative sentiment."
    },
    {
      icon: <Download className="h-10 w-10 text-blue" />,
      title: "Export Results",
      description: "View detailed insights and export reports in various formats for your team."
    }
  ];
      ...
      <div className="container mx-auto px-4 py-16">
        <div className="max-w-4xl mx-auto animate-fade-in">
          <h1 className="text-3xl md:text-4xl font-bold text-white text-center mb-4">
            How to Use <span className="text-blue">SentimentSage</span>
          </h1>
          ...
          <div className="space-y-6 mb-12">
            <h2 className="text-2xl font-bold text-white">Detailed Instructions</h2>
            
            <div className="card p-6">
              <h3 className="text-xl font-bold text-white mb-2">1. Upload Your Comments</h3>
              ...
              <ul className="list-disc pl-5 text-gray-300 space-y-2">
                ...
                <li>Upload a CSV file with comments (requires column headers)</li>
                <li>Connect to a social media platform using our integrations</li>
              </ul>
            </div>
            
            <div className="card p-6">
              <h3 className="text-xl font-bold text-white mb-2">2. Analyze Sentiment</h3>
              <p className="text-gray-300 mb-4">
                After uploading your comments:
              </p>
              <ul className="list-disc pl-5 text-gray-300 space-y-2">
                <li>Click the "Analyze" button to start processing</li>
                <li>Our AI will process each comment and determine its sentiment</li>
                <li>The analysis typically takes a few seconds to complete</li>
                <li>View the results on your dashboard with detailed breakdowns</li>
              </ul>
            </div>
            
            <div className="card p-6">
              <h3 className="text-xl font-bold text-white mb-2">3. Export Results</h3>
              <p className="text-gray-300 mb-4">
